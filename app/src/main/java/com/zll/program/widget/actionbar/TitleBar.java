package com.zll.program.widget.actionbar;
...
import com.zll.program.utils.ThemeUtils;
import com.zll.program.widget.AutoMoveTextView;
import com.zll.program.widget.alpha.XUIAlphaTextView;
...
public class TitleBar extends ViewGroup implements View.OnClickListener{
    ...
    private void initView(Context context) {
        ...
        mSubTitleText.setPadding(0, DensityUtil.dip2px(getContext(), 2), 0, 0);
    ...
    public TitleBar setBackImageResource(int resId) {
        if (resId != 0) {
            mLeftImageResource = MyApplication.getInstance().getResources().getDrawable(resId);
            mLeftImageResource.setBounds(0, 0, DensityUtil.dip2px(getContext(), 12), DensityUtil.dip2px(getContext(), 22));
